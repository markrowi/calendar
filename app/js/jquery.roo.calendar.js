(function($, window, document){
    ...
    $.extend(Plugin.prototype, {
        ...
        updateEvents:function(eventArr) {
            updateEvents = $('.events')
            eventArr = this.checkCollision(eventArr);
            ...
            var width = (Math.floor(this.settings.cellWidth -3) /(arr[i].totalColumns+1))+'px';
            var left = (Math.floor(this.settings.cellWidth - 3)/(arr[i].totalColumns+1)*arr[i].column)+'px';
